...
data "archive_file" "assets" {
  ...
  output_path = "./.terraform/generated_${sha1("${module.tectonic.id} ${module.bootkube.id} ${module.flannel_vxlan.id} ${module.calico-bgp.id} ${module.calico_network_policy.id}")}.zip"
}
